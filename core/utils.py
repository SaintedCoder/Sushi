...
def get_Sushi_version():
    for mod_name in bpy.context.preferences.addons.keys():
        ...
        if name == "Sushi":
            ...
            return version
    print(
        "utils::get_Sushi_version reports: Something went wrong when trying to get the Sushi version"
    )
    return False
...
def format_ctm(container=None):
    ...
    formatted_text = "# Character Template Map auto-generated by Sushi\n"
...
def format_ccm(container=None):
    ...
    formatted_text = "# Character Converter Map auto-generated by Sushi\n"
...
def flag_reloader():
    ...
    target_path = temp_path + "/Sushi_reloader" + ".py"
...
def record_rig():
    ...
    rig_path = "L:/compile/Sushi/test_material/" + rig_file
